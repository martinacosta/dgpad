function ExportPanel(_canvas, _closeProc) {
    ...
    var getPAGE = function() {
		...
		s += '"http://localhost:8080/estudiantes"';}}
					...
					s += '"https://dgpad-colombia.udistrital.edu.co/profesores.html"';
			} else {
		s += '"https://dgpad-colombia.udistrital.edu.co/estudiantes.html"';}}
        ...
        s += 'src="https://dgpad-colombia.udistrital.edu.co/estudiantes/empty.html" scrolling="no" frameborder="no"';
