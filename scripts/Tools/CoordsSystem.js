...
//MEAG >Modificación para que las figuras salgan proporcionales en todas las pantallas
    me.getSource = function() {
		...
		if (Cn.getCanvas().hasOwnProperty("VarillasD")|Cn.getCanvas().hasOwnProperty("VarillasC")){
			...
			var varillasd=Cn.getCanvas()["VarillasD"];
			console.log(varillasc);
			console.log(varillasd);
			txt+="VarillasC="+varillasc+";\n VarillasD="+varillasd+";\n";
			txt+="GetCanvas()['VarillasD']="+JSON.stringify(varillasd)+";\n GetCanvas()['VarillasC']="+JSON.stringify(varillasc)+";\n";
		}
		//fin modificacion bases
        return txt;
    };
