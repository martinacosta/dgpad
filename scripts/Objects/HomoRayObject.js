...
function HomoRayObject(_construction, _name, _E, _S, _P) {
	...
	var puntos=[_S.getP1(),_S.getP2()];
	  ...
	  if (ptoExistente>-1){rot1=homoPuntos[ptoExistente]}
	  if (ptoExistente==-1) {rot1=new HomoPointObject(_construction, "_P", E, puntos[0], P);_construction.add(rot1);}
var ptoExistente=-1;
	  for (var j = 0, len2 = homoPuntos.length; j < len2; j++) {
	  ...
	  if (ptoExistente>-1){rot2=homoPuntos[ptoExistente]}
	  if (ptoExistente==-1) {rot2=new HomoPointObject(_construction, "_P", E, puntos[1], P);_construction.add(rot2);}
