...
//             .appendField(new Blockly.FieldDropdown([[$L.button_title_arrow,"arrow"], [$L.button_title_gomme,"hide"], [$L.button_title_trash,"trash"],[$L.button_title_macros,"macros"],[$L.button_title_calc , "calc"],[$L.button_title_tex , "tex"],[$L.button_title_properties , "properties"],[$L.button_title_history , "history"],[$L.button_title_copy,"copy"],[$L.button_title_name,"name"],[$L.button_title_grid,"grid"],[$L.button_title_zoom,"zoom"],[$L.button_title_lPress,"OtherTools"],[$L.button_title_undo,"undo"],[$L.button_title_redo,"redo"]]), "BUTTON");
...
Blockly.Blocks['dgpad_restrictions_setButton'] = {
  init: function() {
    this.setPreviousStatement(true);
    this.setNextStatement(true);

    this.appendDummyInput()
      .appendField('Barra:') // cámbialo por $L... si quieres i18n
      .appendField(new Blockly.FieldDropdown([
        ['Activar', 'enable'],
        ['Desactivar', 'disable']
      ]), 'ACTION')
      .appendField(new Blockly.FieldDropdown([
        [$L.button_title_arrow, "arrow"],
        [$L.button_title_gomme, "hide"],
        [$L.button_title_trash, "trash"],
        [$L.button_title_macros, "macros"],
        [$L.button_title_calc, "calc"],
        [$L.button_title_tex, "tex"],
        [$L.button_title_properties, "properties"],
        [$L.button_title_history, "history"],
        [$L.button_title_copy, "copy"],
        [$L.button_title_name, "name"],
        [$L.button_title_grid, "grid"],
        [$L.button_title_zoom, "zoom"],
        [$L.button_title_lPress, "OtherTools"],
        [$L.button_title_undo, "undo"],
        [$L.button_title_redo, "redo"]
      ]), 'BUTTON');
...
Blockly.Blocks['dgpad_restrictions_setTool'] = {
  init: function() {
    this.setPreviousStatement(true);
    this.setNextStatement(true);

    this.appendDummyInput()
      .appendField('Herramienta:') // cámbialo por $L... si quieres i18n
      .appendField(new Blockly.FieldDropdown([
        ['Activar', 'enable'],
        ['Desactivar', 'disable']
      ]), 'ACTION')
      .appendField(new Blockly.FieldDropdown([
        ...
        [$L.tool_title_anglebiss, "anglebiss"],
        [$L.tool_title_arc3pts, "arc3pts"],
        [$L.tool_title_area, "area"],
        [$L.tool_title_blockly, "@blockly"],
        [$L.tool_title_callcalc, "@callcalc"],
        [$L.tool_title_calldepends, "@calldepends"],
        [$L.tool_title_callhide, "@callhide"],
        [$L.tool_title_calllist, "@calllist"],
        [$L.tool_title_callmagnet, "@magnet"],
        [$L.tool_title_callproperty, "@callproperty"],
        [$L.tool_title_calltrash, "@calltrash"],
        [$L.tool_title_callvalue, "@callvalue"],
        [$L.tool_title_circle, "circle"],
        [$L.tool_title_circle1, "circle1"],
        [$L.tool_title_circle3, "circle3"],
        [$L.tool_title_circle3pts, "circle3pts"],
        [$L.tool_title_dgscriptname, ",@dgscriptname"],
        [$L.tool_title_doceval, "@doceval"],
        [$L.tool_title_fixedangle, "fixedangle"],
        [$L.tool_title_floatingobject, "@pushpin"],
        [$L.tool_title_homothety, "homotecia"],
        [$L.tool_title_intersect, "circle_int"],
        [$L.tool_title_line, "line"],
        [$L.tool_title_locus, "locus"],
        [$L.tool_title_midpoint, "midpoint"],
        [$L.tool_title_namemover, "@namemover"],
        [$L.tool_title_noanchor, "noanchor"],
        [$L.tool_title_objectmover, "@objectmover"],
        [$L.tool_title_parallel, "parallel"],
        [$L.tool_title_perpbisector, "perpbis"],
        [$L.tool_title_plumb, "plumb"],
        [$L.tool_title_point, "point"],
        [$L.tool_title_ray, "ray"],
        [$L.tool_title_removevalue, "@removevalue"],
        [$L.tool_title_rotate, "rot"],
        [$L.tool_title_segment, "segment"],
        [$L.tool_title_spring, "spring"],
        [$L.tool_title_syma, "syma"],
        [$L.tool_title_symc, "symc"],
        [$L.tool_title_trans, "trans"],
...
Blockly.Blocks['dgpad_restrictions_SystemProperties'] = {
  init: function() {
    ...
    this.appendDummyInput()
      ...
      .appendField(new Blockly.FieldCheckbox("TRUE"), "gridShow");

    this.appendDummyInput()
      .appendField($L.blockly.restrictions_oxShow)
      .appendField(new Blockly.FieldCheckbox("TRUE"), "oxShow");

    this.appendDummyInput()
      .appendField($L.blockly.restrictions_oyShow)
      .appendField(new Blockly.FieldCheckbox("TRUE"), "oyShow");

    this.appendDummyInput()
      .appendField($L.blockly.restrictions_fixOx)
      .appendField(new Blockly.FieldCheckbox("FALSE"), "fixOx");

    this.appendDummyInput()
      .appendField($L.blockly.restrictions_fixOy)
      .appendField(new Blockly.FieldCheckbox("FALSE"), "fixOy");

    this.appendDummyInput()
      .appendField($L.blockly.restrictions_onlyPos)
      .appendField(new Blockly.FieldCheckbox("FALSE"), "onlyPos");

    this.appendDummyInput()
      .appendField($L.blockly.restrictions_zoomOrigin)
      .appendField(new Blockly.FieldCheckbox("FALSE"), "zoomOrigin");
...
Blockly.Blocks['dgpad_protect_object'] = {
    init: function() {
        this.appendDummyInput()
            .appendField(new Blockly.FieldDropdown([
                [$L.blockly.restrictions_protect1, "true"],
                [$L.blockly.restrictions_protect2, "false"]
            ]), "PROTECT")
        ...
        this.setColour(47);
        this.setTooltip('Protege o desprotege un objeto para evitar su edición o eliminación');
        this.setHelpUrl('');
    }
};
