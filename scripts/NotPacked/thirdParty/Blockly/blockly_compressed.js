    ...
    if (!goog.transpiledLanguages_) {
      ...
      try {
        ((goog.transpiledLanguages_.es5 = eval("[1,].length!=1")),
          ...
          ) && (goog.transpiledLanguages_["es6-impl"] = !1),
          eval(
  ...
  for (
    ...
    do {
      ...
      var c = 0 == h[1].length ? 0 : parseInt(h[1], 10),
        ...
        c =
          goog.string.compareElements_(c, m) ||
...
goog.dom.createTable_ = function (a, b, c, d) {
  for (
    var e = a.createElement("TABLE"),
      f = e.appendChild(a.createElement("TBODY")),
      g = 0;
    g < b;
    g++
  ) {
...
goog.style.parseStyleAttribute = function (a) {
  ...
  goog.array.forEach(a.split(/\s*;\s*/), function (a) {
    ...
    d &&
      ((a = d[1]),
      (d = goog.string.trim(d[2])),
      (b[goog.string.toCamelCase(a.toLowerCase())] = d));
  });
  return b;
};
...
Blockly.Workspace.prototype.renameVariable = function (a, b) {
  ...
  c == d || (-1 != c && -1 == d)
    ...
    : -1 != c && -1 != d
      ? (this.variableList.splice(c, 1), (this.variableList[d] = b))
...
Blockly.Field.prototype.updateEditable = function () {
  ...
  this.EDITABLE &&
    ...
    (this.sourceBlock_.isEditable()
      ? (Blockly.addClass_(a, "blocklyEditableText"),
        Blockly.removeClass_(a, "blocklyNonEditableText"),
        (this.fieldGroup_.style.cursor = this.CURSOR))
      : (Blockly.addClass_(a, "blocklyNonEditableText"),
...
Blockly.Field.prototype.render_ = function () {
  if (this.visible_ && this.textElement_) {
    ...
    this.borderRect_ &&
      this.borderRect_.setAttribute("width", b + Blockly.BlockSvg.SEP_SPACE_X);
  } else b = 0;
  this.size_.width = b;
};
...
Blockly.Tooltip.onMouseMove_ = function (a) {
  // console.log("MOUSE MOVE EVENT:", a);
  if (
...
Blockly.Scrollbar = function (a, b, c) {
  ...
  this.onMouseDownHandleWrapper_ = Blockly.bindEvent_(
    this.svgHandle_,
    "mousedown",
    this,
...
Blockly.Scrollbar.prototype.createDom_ = function () {
  ...
  this.svgHandle_ = Blockly.createSvgElement(
    "rect",
...
Blockly.Xml.workspaceToDom = function (a) {
  ...
  for (var c = 0, d; (d = a[c]); c++)
    b.appendChild(Blockly.Xml.blockToDomWithXY(d));
  return b;
};
...
Blockly.Xml.blockToDom = function (a) {
  ...
  for (c = 0; (d = a.inputList[c]); c++) {
    ...
    d.type != Blockly.DUMMY_INPUT &&
      ((g = d.connection.targetBlock()),
      d.type == Blockly.INPUT_VALUE
        ? (h = goog.dom.createDom("value"))
        : d.type == Blockly.NEXT_STATEMENT &&
          (h = goog.dom.createDom("statement")),
      (e = d.connection.getShadowDom()),
      !e || (g && g.isShadow()) || h.appendChild(Blockly.Xml.cloneShadow_(e)),
      g && (h.appendChild(Blockly.Xml.blockToDom(g)), (f = !1)),
  ...
  if ((c = a.getNextBlock()))
    ((h = goog.dom.createDom("next", null, Blockly.Xml.blockToDom(c))),
      b.appendChild(h));
...
Blockly.ZoomControls.prototype.createDom = function () {
  ...
  var e = Blockly.createSvgElement(
    "image",
    {
      width: Blockly.SPRITE.width,
      height: Blockly.SPRITE.height,
    ...
    try {
      ...
      if (!isNaN(c) && !isNaN(d)) {
        ...
        do {
          ...
          if (!a)
            for (var k = b.getConnections_(!1), f = 0, m; (m = k[f]); f++)
              if (
                m.closest(Blockly.SNAP_RADIUS, new goog.math.Coordinate(c, d))
                  .connection
              ) {
                a = !0;
                break;
  ...
  if (!this.options.readOnly && !this.isFlyout) {
    ...
    if (this.options.collapse) {
      for (var h = (g = !1), k = 0; k < e.length; k++)
        for (var m = e[k]; m; )
          (m.isCollapsed() ? (g = !0) : (h = !0), (m = m.getNextBlock()));
      var p = function (a) {
    ...
    g = {
      ...
      callback: function () {
        (2 > l.length ||
          window.confirm(
            Blockly.Msg.DELETE_ALL_BLOCKS.replace("%1", String(l.length)),
          )) &&
          c();
      },
    };
...
Blockly.BlockSvg.prototype.onMouseDown_ = function (a) {
  // console.log("MOUSE DOWN EVENT 1:", a);
...
Blockly.BlockSvg.prototype.renderCompute_ = function (a) {
  ...
  for (
    var d = 0,
      ...
      h = !1,
      k = void 0,
      m = this.getInputsInline() && !this.isCollapsed(),
      p = 0,
      l;
    (l = b[p]);
    p++
    ...
    if (l.isVisible()) {
      ...
      m && k && k != Blockly.NEXT_STATEMENT && l.type != Blockly.NEXT_STATEMENT
        ...
        : ((k = l.type),
          (n = []),
          (n.type =
            m && l.type != Blockly.NEXT_STATEMENT
      ...
      n.type != Blockly.BlockSvg.INLINE &&
        (n.type == Blockly.NEXT_STATEMENT
          ? ((g = !0), (e = Math.max(e, l.fieldWidth)))
          : (n.type == Blockly.INPUT_VALUE
              ? (f = !0)
              : n.type == Blockly.DUMMY_INPUT && (h = !0),
      ...
      for (var q = 0; (n = l[q]); q++)
        ((k = h),
          ...
          n.type != Blockly.DUMMY_INPUT &&
            (g += n.renderWidth + Blockly.BlockSvg.SEP_SPACE_X),
          n.type == Blockly.INPUT_VALUE &&
            (c.push(
              "M",
              g -
      ...
      l.type == Blockly.INPUT_VALUE
        ? ((n = l[0]),
          ...
          n.align != Blockly.ALIGN_LEFT &&
            ...
            n.align == Blockly.ALIGN_RIGHT
              ? (g += q)
              : n.align == Blockly.ALIGN_CENTRE && (g += q / 2)),
          this.renderFields_(n.fieldRow, g, k),
        ...
        : l.type == Blockly.DUMMY_INPUT
          ? ((n = l[0]),
            ...
            n.align != Blockly.ALIGN_LEFT &&
              ((q =
                e.rightEdge - n.fieldWidth - 2 * Blockly.BlockSvg.SEP_SPACE_X),
...
Blockly.Events.setGroup = function (a) {
  Blockly.Events.group_ =
    "boolean" == typeof a ? (a ? Blockly.genUid() : "") : a;
};
...
Blockly.FieldTextInput.prototype.showEditor_ = function (a) {
  ...
  if (
    ...
    this.resizeEditor_();
    a || (c.focus(), c.select());
    c.onKeyDownWrapper_ = Blockly.bindEvent_(
      c,
      "keydown",
      this,
      this.onHtmlInputKeyDown_,
    );
    c.onKeyUpWrapper_ = Blockly.bindEvent_(
      c,
      "keyup",
      this,
      this.onHtmlInputChange_,
    );
    c.onKeyPressWrapper_ = Blockly.bindEvent_(
      c,
      "keypress",
      this,
      this.onHtmlInputChange_,
  ...
  for (;;) {
    ...
    if (b)
      if (-1 != a.variableIndexOf(b))
        window.alert(
          Blockly.Msg.VARIABLE_ALREADY_EXISTS.replace("%1", b.toLowerCase()),
        );
      else {
        a.createVariable(b);
        break;
...
Blockly.FieldVariable.prototype.classValidator = function (a) {
  ...
  if (a == Blockly.Msg.RENAME_VARIABLE) {
    var c = this.getText();
    Blockly.hideChaff();
    (a = Blockly.Variables.promptName(
      Blockly.Msg.RENAME_VARIABLE_TITLE.replace("%1", c),
      c,
...
Blockly.Generator.prototype.provideFunction_ = function (a, b) {
  if (!this.definitions_[a]) {
    ...
    for (
      ...
      ((d = c), (c = c.replace(/^((  )*)  /gm, "$1" + this.INDENT)));
...
Blockly.FlyoutButton.prototype.createDom = function () {
  ...
  var a = Blockly.createSvgElement(
    ...
    c = Blockly.createSvgElement(
      "text",
      { class: "blocklyText", x: 0, y: 0, "text-anchor": "middle" },
      this.svgGroup_,
    );
...
Blockly.Flyout.prototype.getMetrics_ = function () {
  ...
  if (this.horizontalLayout_) {
    ...
    this.toolboxPosition_ == Blockly.TOOLBOX_AT_TOP &&
      (d += this.MARGIN - this.SCROLLBAR_PADDING);
  ...
  if (this.isVisible()) {
    ...
    if (a) {
      ...
      this.setBackgroundPath_(
        b,
        this.horizontalLayout_ ? this.height_ : a.viewHeight,
      );
      b = a.absoluteLeft;
...
Blockly.Flyout.prototype.setBackgroundPathHorizontal_ = function (a, b) {
  ...
  c
    ? (d.push("h", a + this.CORNER_RADIUS),
      ...
      d.push("h", -1 * (a - this.CORNER_RADIUS)),
      d.push(
        "a",
        this.CORNER_RADIUS,
        this.CORNER_RADIUS,
...
Blockly.Flyout.prototype.show = function (a) {
    ...
    if (e.tagName) {
      ...
      "BLOCK" == f
        ? ((f = Blockly.Xml.domToBlock(e, this.workspace_)),
          ...
          c.push(isNaN(e) ? g : e))
        : "SEP" == e.tagName.toUpperCase()
          ? ((e = parseInt(e.getAttribute("gap"), 10)),
            !isNaN(e) && 0 < c.length ? (c[c.length - 1] = e) : c.push(g))
          : "BUTTON" == f &&
            ((e = e.getAttribute("text")),
  ...
  this.listeners_.push(
    Blockly.bindEvent_(this.svgBackground_, "mouseover", this, function () {
      for (var a = this.workspace_.getTopBlocks(!1), b = 0, c; (c = a[b]); b++)
        c.removeSelect();
    }),
  );
  ...
  for (var e = 0, f; (f = a[e]); e++)
    if ("block" == f.type) {
      ...
      "button" == f.type &&
        ...
        f.moveTo(d, c),
        f.show(),
        Blockly.bindEvent_(g, "mouseup", f, f.onMouseUp),
...
Blockly.Flyout.prototype.addBlockListeners_ = function (a, b, c) {
  try {
    a && a.setAttribute && a.setAttribute("pointer-events", "auto");
    c && c.setAttribute && c.setAttribute("pointer-events", "auto");
    // Force pointer-events on all children of the block group so paths receive mousedown
    if (a && a.querySelectorAll) {
      var nodes = a.querySelectorAll("*");
      for (var i = 0; i < nodes.length; i++) {
        nodes[i].setAttribute("pointer-events", "visiblePainted");
      }
    }
  } catch (e) {}
  this.listeners_.push(
    Blockly.bindEvent_(a, "mousedown", null, this.blockMouseDown_(b)),
  );
  this.listeners_.push(
    Blockly.bindEvent_(c, "mousedown", null, this.blockMouseDown_(b)),
  );
...
Blockly.Flyout.prototype.blockMouseDown_ = function (a) {
  ...
  return function (c) {
    a &&
      a.svgGroup_ &&
      a.svgGroup_.setAttribute &&
      a.svgGroup_.setAttribute("pointer-events", "auto");
    a &&
      a.getSvgRoot &&
      a.getSvgRoot() &&
      a.getSvgRoot().setAttribute &&
      a.getSvgRoot().setAttribute("pointer-events", "auto");
    Blockly.terminateDrag_();
    Blockly.hideChaff(!0);
...
Blockly.Flyout.prototype.onMouseDown_ = function (a) {
  // Attempt to detect a block under the cursor when mousedown occurs on the flyout background/canvas.
  var maybeBlock = null;
  try {
    var blocks = this.workspace_.getTopBlocks(!1);
    for (var i = 0; i < blocks.length; i++) {
      var root = blocks[i].getSvgRoot && blocks[i].getSvgRoot();
  ...
  if (maybeBlock) {
    // Manually route to the block-specific handler and exit.
    this.blockMouseDown_(maybeBlock)(a);
    return;
  }
  Blockly.isRightButton(a) ||
    (Blockly.hideChaff(!0),
...
Blockly.createDom_ = function (a, b) {
  ...
  var g = Blockly.createSvgElement(
    "feSpecularLighting",
    {
      in: "blur",
      surfaceScale: 1,
  ...
  0 < b.gridOptions.length &&
    ...
    (Blockly.createSvgElement("line", { stroke: b.gridOptions.colour }, d),
...
Blockly.getRelativeXY_ = function (a) {
  ...
  if (
    (a =
      ...
      a.match(Blockly.getRelativeXY_.XY_REGEXP_))
  )
...
Blockly.getSvgXY_ = function (a, b) {
  var c = 0,
    ...
    e = 1;
  if (
    goog.dom.contains(b.getCanvas(), a) ||
    goog.dom.contains(b.getBubbleCanvas(), a)
  )
    e = b.scale;
  do {
