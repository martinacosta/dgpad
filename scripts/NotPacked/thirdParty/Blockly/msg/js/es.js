...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 = "Si un valor es verdadero, entonces ejecutar algunas acciones.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 = "Si un valor es verdadero, entonces ejecutar el primer bloque de acciones.  De lo contrario, ejecutar el segundo bloque de accopmes.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 = "Si el primer valor es verdadero, entonces ejecutar el primer bloque de acciones. De lo contrario, si el segundo valor es verdadero, ejecutar el segundo bloque de acciones.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 = "Si el primer valor es verdadero, entonces ejecutar el primer bloque de acciones. De lo contrario, si el segundo valor es verdadero, ejecutar el segundo bloque de acciones. Si ninguno de los valores son verdaderos, ejecutar el último bloque de acciones.";
...
Blockly.Msg.CONTROLS_REPEAT_TOOLTIP = "Ejecutar algunas acciones varias veces.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL = "Mientras un valor sea falso, ejecutar algunas acciones.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE = "Mientras un valor sea verdadero, ejecutar algunas acciones.";
Blockly.Msg.DELETE_ALL_BLOCKS = "¿Eliminar todos los %1 bloques?";
Blockly.Msg.DELETE_BLOCK = "Eliminar bloque";
Blockly.Msg.DELETE_VARIABLE = "Borrar la variable '%1'";  // untranslated
Blockly.Msg.DELETE_VARIABLE_CONFIRMATION = "Borrar %1 usos de la variable '%2'?";  // untranslated
...
Blockly.Msg.MATH_TRIG_TOOLTIP_COS = "Devuelve el coseno de un ènagulo en grados (no radianes).";
Blockly.Msg.MATH_TRIG_TOOLTIP_SIN = "Devuelve el seno de un ènagulo en grados (no radianes).";
...
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP = "Ejecuta la función '%1' definida por el usuario y usa su salida.";
...
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_TITLECASE = "en Mayúsculas Cada Palabra";
...
Blockly.Msg.VARIABLES_SET = "establecer %1 como %2";
...
Blockly.Msg.VARIABLE_ALREADY_EXISTS = "ya existe una variable  '%1'.";  
