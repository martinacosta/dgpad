function BlocklyPanel(
  ...
  me.setbounds = function (l, t, w, h) {
    ...
    rz.bnds(
      w - rz_width - rz_margin,
      h - rz_width - rz_margin,
      rz_width,
      rz_width,
    );
  ...
  var resizemove = function (ev) {
    ...
    var h = height + coords.y - yy < 100 ? height : height + coords.y - yy;
  ...
  var select_tab = function (_s) {
    ...
    if (_s !== current_tab) {
      ...
      tabs[_s].stls(
        "background-color:rgba(245,245,245,1);color:rgba(30,30,30,1)",
      );
    }
  };
  ...
  var createtab = function (_n) {
    ...
    t.stls(
      "cursor:pointer;border-left: 1px solid #b4b4b4;border-bottom: 1px solid #b4b4b4;border-right: 1px solid #b4b4b4;background-color:rgba(90,90,90,1);color:rgba(230,230,230,1);position:absolute;border-bottom-right-radius:10px;width:" +
        tab_width +
        "px;height:" +
        tab_height +
        "px;font-size: 14px;font-weight:normal;font-family: Helvetica, Arial, sans-serif;text-align: center;white-space: pre-wrap;margin: 0px;line-height:" +
        tab_height +
  ...
  wp.stls(
    "position:absolute;border-bottom-left-radius:10px;border-bottom-right-radius:10px;overflow:hidden;border: 1px solid #b4b4b4;transition:transform 0.2s linear;transform:scale(0);z-index:9000",
  );
  tl.stls(
    "cursor:all-scroll;background-color:rgba(210,210,210,1);position:absolute;font-size: 16px;font-family: Helvetica, Arial, sans-serif;text-shadow: 1px 1px 5px #777;text-align: center;white-space: pre-wrap;margin: 0px;vertical-align:middle",
  );
  ...
  rz.stls(
    "background-color:rgba(0,0,0,0);position:absolute;background-position:center;background-repeat:no-repeat;background-size:100% 100%;cursor:se-resize",
  );
  ...
  tl.md(dragdown);
  tl.mu(dragup);
  tl.addEventListener("touchstart", dragdown, false);
  rz.md(resizedown);
  rz.mu(resizeup);
  rz.addEventListener("touchstart", resizedown, false);
